...
--
-- Table structure for table `x_ker_wip_w1_bt`
--

DROP TABLE IF EXISTS `x_ker_wip_w1_bt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `x_ker_wip_w1_bt` (
...
--
-- Dumping data for table `x_ker_wip_w1_bt`
--

LOCK TABLES `x_ker_wip_w1_bt` WRITE;
/*!40000 ALTER TABLE `x_ker_wip_w1_bt` DISABLE KEYS */;
/*!40000 ALTER TABLE `x_ker_wip_w1_bt` ENABLE KEYS */;
UNLOCK TABLES;
