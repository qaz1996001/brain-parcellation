...
--
-- Table structure for table `oee_ss_hr_bth`
--

DROP TABLE IF EXISTS `oee_ss_hr_bth`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oee_ss_hr_bth` (
  ...
  PRIMARY KEY (`report_time`,`tool_id`,`cate`,`device`)
...
--
-- Dumping data for table `oee_ss_hr_bth`
--

LOCK TABLES `oee_ss_hr_bth` WRITE;
/*!40000 ALTER TABLE `oee_ss_hr_bth` DISABLE KEYS */;
/*!40000 ALTER TABLE `oee_ss_hr_bth` ENABLE KEYS */;
UNLOCK TABLES;
