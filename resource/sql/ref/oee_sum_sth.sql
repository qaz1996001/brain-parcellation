...
--
-- Table structure for table `oee_sum_sth`
--

DROP TABLE IF EXISTS `oee_sum_sth`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oee_sum_sth` (
...
--
-- Dumping data for table `oee_sum_sth`
--

LOCK TABLES `oee_sum_sth` WRITE;
/*!40000 ALTER TABLE `oee_sum_sth` DISABLE KEYS */;
/*!40000 ALTER TABLE `oee_sum_sth` ENABLE KEYS */;
UNLOCK TABLES;
