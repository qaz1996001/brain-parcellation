...
--
-- Table structure for table `ker_wip_tt`
--

DROP TABLE IF EXISTS `ker_wip_tt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ker_wip_tt` (
...
--
-- Dumping data for table `ker_wip_tt`
--

LOCK TABLES `ker_wip_tt` WRITE;
/*!40000 ALTER TABLE `ker_wip_tt` DISABLE KEYS */;
INSERT INTO `ker_wip_tt` VALUES ('2020-05-05 09:13:17','RT','A01000380.0','A01000380.0',NULL,NULL,'ACS002',NULL,2100,20,2100,20,105,NULL,'Q',1,'ACQ51F-1','ACQ51F-1','ROUTE-ZZZ-01',NULL,'860.100','雷刻','Marking','雷刻站','860','stb',0,'2020-05-05 09:13:17','SYS','Others','Others','0',NULL,'0','0','0',0,NULL,NULL,'Mark-1',NULL,NULL,NULL,'AZMKD01',NULL,NULL,2,'ZZZ-01',NULL,'860.100','MFG_NO-107',0,NULL,NULL,'act: laser marking lot',NULL,'2020-05-05 09:13:17','2020-05-05 09:13:18',NULL,NULL,'ACQ51F-1',NULL,'powder1',2100,2100,2100,0,0,0,2100,0,'2019/11/25',NULL,'2019/01/01',NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,'2020-05-05 01:13:17.979675');
/*!40000 ALTER TABLE `ker_wip_tt` ENABLE KEYS */;
UNLOCK TABLES;
