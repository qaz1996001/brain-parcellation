...
def tes_pipeline_save_file_tasks():
    ...
    for study_path in study_list:
        ...
        synthseg_file = study_path.joinpath(
            "synthseg_T1BRAVO_AXI_original_synthseg.nii.gz"
        )
        synthseg33_file = study_path.joinpath(
            "synthseg_T1BRAVO_AXI_original_synthseg33.nii.gz"
        )
