...
def main(args):
    ...
    if args.template:
        ...
        template_synthseg33_file_list = list(map(lambda x: x.parent.joinpath(replace_suffix(x.name, f'_synthseg33.nii.gz')),
                                                 template_file_list))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', dest='input', type=str, #required=True,
                        default=r'D:\00_Chen\Task08\MRI scale\WMH_3',
    ...
    parser.add_argument('--WMH', '--wmh', dest='wmh', type=str_to_bool, default=True,#default=False,
