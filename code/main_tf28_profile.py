...
# from review_predict_tf28 import resample_one, SynthSeg
from review_predict_tf28_profiler import resample_one, SynthSeg
from utils_parcellation_profiler import CMBProcess, DWIProcess, run_wmh, run_with_WhiteMatterParcellation
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser()
    parser.add_argument('-i', '--input', dest='input', type=str, #required=True,
                        default=r'D:\00_Chen\Task04_\R038_ICH_20180209_HUNG_SHENG_SUNG',
                        help="input the (SHH seg)synthseg file path (nii , nii.gz) or input the folder path.\r\n"
                             "Example ： python utils_parcellation.py -i input_path ")
    parser.add_argument('--input_name', dest='input_name', type=str,
                        default='SWAN',
    ...
    parser.add_argument('--all', dest='all', type=str_to_bool, default=False,
                        help="run all algorithm with input (file,folder)，default is True.")
    ...
    parser.add_argument('--CMB', '--cmb', dest='cmb', type=str_to_bool, default=True,
                        help="output CMB Mask")
    parser.add_argument('--CMBFile', '--cmbFile', dest='cmb_file', type=str, default='CMB',
                        help="CMB Mask file name，default is \'{output}_CMB.nii.gz\' ， use \'{output}_{"
                             "cmb_file}.nii.gz\'")
