...
def pipeline_synthseg(
    ...
    logging.info("!!! pipeline_synthseg5class_tensorflow  call.")
    ...
    try:
        ...
        if gpumRate < 0.7:
            ...
            original_file_path_list = glob.glob(
                "{}/synthseg*_original_synthseg*.nii.gz".format(path_processID)
            )
...
if __name__ == "__main__":
    ...
    if file_path is not None:
        stdout, stderr = dicom_seg_multi_file(
            ID, InputsDicomDir, file_path, path_output
        )
