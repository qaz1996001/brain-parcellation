...
#             self.dicom_rename_result_list = self.dicom_rename_only(
#                 input_dicom_path, output_dicom_path
#             )
#             print('self.dicom_rename_result_list',self.dicom_rename_result_list)
#             self.renamed_nifti_result_list = self.renamed_dicom_to_nifti(
#                 output_dicom_path, output_nifti_path
#             )
#             print('self.renamed_nifti_result_list', self.renamed_nifti_result_list)
#
