...
import pynvml  # 导包
from util_aneurysm import reslice_nifti_pred_nobrain, create_MIP_pred, make_aneurysm_vessel_location_16labels_pred, \
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ID', type=str, default='1C95C88E_20171122_MR_1C95C88E',
                        help='目前執行的case的patient_id or study id')
    parser.add_argument('--Inputs', type=str, nargs='+',
                        default=['/mnt/e/pipeline/chuan/example_input/1C95C88E_20171122_MR_1C95C88E/MRA_BRAIN.nii.gz'],
                        help='用於輸入的檔案')
    parser.add_argument('--DicomDir', type=str, nargs='+',
                        default=['/mnt/e/pipeline/chuan/example_inputDicom/1C95C88E_20171122_MR_1C95C88E/MRA_BRAIN/'],
                        help='用於輸入的檔案')
    ...
    pipeline_aneurysm(ID,
                      MRA_BRAIN_file,
                      path_output,
                      path_code, path_processModel, path_DcmDir, path_json, path_log,
                      gpu_n)
