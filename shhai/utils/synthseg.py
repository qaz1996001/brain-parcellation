...
from shhai import FSL_FLIRT

from shhai.ext.lab2im import utils, layers, edit_volumes
from shhai.ext.neuron import models as nrn_models

from shhai.SynthSeg.predict import get_flip_indices
...
class SynthSeg:
    RESOURCE_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                                'resource')
    LABELS_DIR = os.path.join(RESOURCE_DIR, 'labels_classes_priors')
