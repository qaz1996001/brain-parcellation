...
from review_predict_tf28_colab import resample_one, SynthSeg

from utils_parcellation_tf28 import CMBProcess, DWIProcess, run_wmh, run_with_WhiteMatterParcellation
import gc
...
def main(args):
    ...
    if args.depth_number:
        ...
        depth_number = 5
    # print(len(file_list))
    # print(len(resample_file_list))
    # # print(len(template_file_list))
    # # print(len(template_resample_file_list))
    # # print(len(template_synthseg_file_list))
    # # print(len(template_synthseg33_file_list))
    # print(len(cmb_file_list))
    # print(file_list)
